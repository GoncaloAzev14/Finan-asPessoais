...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      {/* 2. Recent Transactions (Movido para cima) */}
      <motion.div
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-bold text-slate-900 tracking-tight">Transações Recentes</h3>
          <div className="flex gap-4 items-center">
            <Link
              to={createPageUrl("Transactions")}
              className="text-sm font-semibold text-slate-400 hover:text-slate-900 flex items-center gap-1 transition-colors"
            >
        ...
        {loadingTransactions ? (
          ...
          <div className="h-48 flex flex-col items-center justify-center text-slate-400">
            ...
            <p className="font-medium">Nenhuma transação este mês</p>
          </div>
        ) : (
          <div className="space-y-3">
      ...
      {/* 3. Charts & Goals (Movido para baixo) */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-bold text-slate-900 tracking-tight">Metas</h3>
            <Link
